...
* ```checkstyle.version``` - Checkstyle version. Or the path to the checkstyle jar file. By default, the extension will use version 8.0. See [checkstyle-8.0-all.jar](https://sourceforge.net/projects/checkstyle/files/checkstyle/8.0/)
